...
factors_out_file  = "gtex_simulation_factors_nmfhals.csv"
loadings_out_file  = "gtex_simulation_loadings_nmfhals.csv"
...
A,W = compute_nmf(counts.T,rank=K,init = 'nndsvd', tol=1e-10, maxiter= MAX_ITER)
