...
factorsoutfile  = join([dataname, '_factors_admm.csv']);
loadingsoutfile = join([dataname, '_loaings_admm.csv']);
erroutfile = join([dataname, '_error_admm.csv']);
