...
factorsoutfile  = join([dataname, '_factors_admm_r',r,'.csv']);
loadingsoutfile = join([dataname, '_loadings_admm_r',r,'.csv']);
erroutfile = join([dataname, '_error_admm_r',r,'.csv']);
...
% ---------------------------
fprintf('Fitting Poisson topic model using admm.\n')
tic;
[A B err] = nmfadmm(counts,L0,F0', r);
timing = toc;
