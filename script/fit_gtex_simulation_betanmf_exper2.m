...
fdiffoutfile  = 'gtex_simulation_fdiff_betanmf.csv';
ldiffoutfile = 'gtex_simulation_ldiff_betanmf.csv';

% readcountsfile   = 'test.csv';
% initfactorsfile  = 'test_factors.csv';
% initloadingsfile = 'test_loadings.csv';
% fdiffoutfile  = 'test_fdiff_betanmf.csv';
% ldiffoutfile = 'test_ldiff_betanmf.csv';
%
% SET UP ENVIRONMENT
% ------------------
addpath ../code
...
tic;
[A B f maxdiffA maxdiffB] = betanmf_exper(counts,L0,F0',tol, MAXITER, verbose, maxtop);
timing = toc;
