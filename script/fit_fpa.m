...
factorsoutfile  = join([dataname, '_factors_fpa.csv']);
loadingsoutfile = join([dataname, '_loadings_fpa.csv']);
erroutfile = join([dataname, '_error_fpa.csv']);
...
% ---------------------------
fprintf('Fitting Poisson topic model using fpa.\n')
tic;
[A B err] = nmf_kl_fpa(counts,L0,F0');
timing = toc;
